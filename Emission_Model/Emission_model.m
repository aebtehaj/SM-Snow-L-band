...
function [Tb] =Emission_model(Tcanopy,tau,omega,h,freq,obs_angle,Tsnow,Tsoil,theta,clayfrac,rho_s)
...
% Run DMRT-QMS Module
[Tb_DMRT,espr_snow,espr_ground]= DMRT_QMS_PM(freq,obs_angle,Tsnow,Tsoil,theta,clayfrac,rho_s,h);
